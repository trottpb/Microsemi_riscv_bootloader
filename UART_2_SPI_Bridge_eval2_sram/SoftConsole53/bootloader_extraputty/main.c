...
-------------------------------------------------------------------------------\r\n\
 ...
 0x20. The device ID is 0xbb and the density is 0x21.\r\n\
...
-------------------------------------------------------------------------------\r\n\
 ...
 Note it is loaded in 4K chunks regardless of the image size make sure you   \r\n\
 dont go over the SRAM size!  \r\n\
";
...
"\r\n\
 Enter the number of 4K chunks to be programed: ";
