# Written by Synplify Pro version mapact2017q4p1, Build 003R. Synopsys Run ID: sid1536323513 
...
create_clock -period 10.000 -waveform {0.000 5.000} -name {DDR3_CCC_0_PF_CCC|pll_inst_0_clkint_4_inferred_clock} [get_pins {MEMORY_0/DDR3_0/CCC_0/pll_inst_0/OUT1}] 
...
set_clock_groups -asynchronous -group [get_clocks {DDR3_CCC_0_PF_CCC|pll_inst_0_clkint_4_inferred_clock}]
...
# set_clock_groups -name Inferred_clkgroup_1 -derive -asynchronous -group c:uj_jtag_85|un1_duttck_inferred_clock
