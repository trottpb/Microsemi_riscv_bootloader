 ...
 */
#define COREGPIO_BASE_ADDR              0x60000000UL
#define COREGPIO_IN_BASE_ADDR           0x60000000UL
#define COREGPIO_OUT_BASE_ADDR          0x60000000UL
#define COREUARTAPB0_BASE_ADDR          0x60010000UL
#define CORESPI_BASE_ADDR               0x60020000UL

#define DDR3_base_address				0x80000000UL
...
/****************************************************************************
 * Baud value to achieve different baud rates with a 100MHz system clock.
...
#define BAUD_VALUE_921600               ((SYS_CLK_FREQ / (16 * 921600)) - 1)
