...
wire           DFI_TRAINING_COMPLETE_INTERNAL; // SIGNIFIES READ TRAINING, WRITE LEVELLING, AND VREF TRAINING IS DONE.
...
//defparam TIP_CTRL_BLK.IOG_DQS_LANES_9 = IOG_DQS_LANES*9;
//defparam TIP_CTRL_BLK.IOG_DQS_LANES_3 = IOG_DQS_LANES*3;
//defparam TIP_CTRL_BLK.IOG_DQS_LANES = IOG_DQS_LANES;
//defparam TIP_CTRL_BLK.IOG_DQS_LANES_64 = IOG_DQS_LANES*64;

//defparam TIP_CTRL_BLK.IOG_DQ_WIDTH_L0 = `IOG_DQ_WIDTH_L0_DEF;
//defparam TIP_CTRL_BLK.IOG_DQ_WIDTH_L1 = `IOG_DQ_WIDTH_L1_DEF;
//defparam TIP_CTRL_BLK.IOG_DQ_WIDTH_L2 = `IOG_DQ_WIDTH_L2_DEF;
//defparam TIP_CTRL_BLK.IOG_DQ_WIDTH_L3 = `IOG_DQ_WIDTH_L3_DEF;
//defparam TIP_CTRL_BLK.IOG_DQ_WIDTH_L4 = `IOG_DQ_WIDTH_L4_DEF;
//defparam TIP_CTRL_BLK.IOG_DQ_WIDTH_L5 = `IOG_DQ_WIDTH_L5_DEF;
//defparam TIP_CTRL_BLK.IOG_DQ_WIDTH_L6 = `IOG_DQ_WIDTH_L6_DEF;
//defparam TIP_CTRL_BLK.IOG_DQ_WIDTH_L7 = `IOG_DQ_WIDTH_L7_DEF;
//defparam TIP_CTRL_BLK.IOG_DQ_WIDTH_L8 = `IOG_DQ_WIDTH_L8_DEF;
...
generate
    ...
    for (k=0; k<IOG_DQS_LANES;k=k+1) begin : VALID_GATING_LOGIC
        ...
        always @ (posedge SCLK or posedge MOVE_LOAD_RESET[k]) begin //Making the move/load reset the counter, this will cause the TIP to immediately gate the valid, preventing move glitches.
            if (MOVE_LOAD_RESET) begin
        ...
        assign IOG_RDDATA_VALID_GATED[k]=|VALID_GATE_COUNTER[3*(k+1)-1:3*k] ? 0 : IOG_RDDATA_VALID[k];
    end
endgenerate
...
begin : delay_dfi_rddata_en
  ...
  begin
    dfi_rddata_en_p0_0 <= DFI_RDDATA_EN_P0;
    dfi_rddata_en_p1_0 <= DFI_RDDATA_EN_P1;
    dfi_rddata_en_p2_0 <= DFI_RDDATA_EN_P2;
    dfi_rddata_en_p3_0 <= DFI_RDDATA_EN_P3;
...
assign IOG_ADDRESS_P0 = DFI_INIT_COMPLETE ? DFI_ADDRESS_P0 : 1'b1;
assign IOG_ADDRESS_P1 = DFI_INIT_COMPLETE ? DFI_ADDRESS_P1 : 1'b0;
assign IOG_ADDRESS_P2 = DFI_INIT_COMPLETE ? DFI_ADDRESS_P2 : 1'b1;
assign IOG_ADDRESS_P3 = DFI_INIT_COMPLETE ? DFI_ADDRESS_P3 : 1'b0;
