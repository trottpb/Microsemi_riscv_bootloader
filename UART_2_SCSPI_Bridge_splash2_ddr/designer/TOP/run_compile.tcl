...
set_compile_info \
    -category {"Source Files"} \
    -name {"Source"} \
    -value {"C:\Microsemiprj_PF23\apps\riscv_bootloader\UART_2_SCSPI_Bridge_splash2_ddr\synthesis\TOP.vm"}
set_compile_info \
    -category {"Options"} \
    -name {"Limit the number of high fanout nets to display to"} \
    -value {"10"}
compile \
    -desdir {C:\Microsemiprj_PF23\apps\riscv_bootloader\UART_2_SCSPI_Bridge_splash2_ddr\designer\TOP} \
    -design TOP \
    -fam PolarFire \
    -die PA5M300T_ES \
    -pkg fcg484 \
